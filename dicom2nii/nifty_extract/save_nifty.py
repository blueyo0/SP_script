...
if __name__ == '__main__':
    # dataset, hk-test
    dataset_dir = '/home/PJLAB/niujingqi/data/TCIA/Data'
    dataset_names = os.listdir(dataset_dir)
    for dataset_name in dataset_names:
        info_csv_file_dir = os.path.join(dataset_dir,dataset_name, 'meta-info.csv' ) #r'/home/PJLAB/niujingqi/data_extra/TCIA/DATA/ACRIN_6657/meta-info.csv'
        save_info_csv_file_dir = os.path.join('/home/PJLAB/niujingqi/Nifty_data', dataset_name, 'save-nifty-meta-info.csv' ) #ACRIN_6657/save-nifty-meta-info.csv'
        save_nii_dir = os.path.join('/home/PJLAB/niujingqi/Nifty_data', dataset_name )
        ...
        for i, row in info_df.iterrows():
            ...
            if  condition_fn2(row):
                ...
                if row['Modality (0008|0060)'] == 'CT':
                    modality = 'CT'
                keep_list.append((1,modality))
            else:
                keep_list.append(0)
        info_df['is_keep'] = keep_list
        # print(keep_list)
        keep_info_df = info_df[info_df['is_keep'][0] == 1]
